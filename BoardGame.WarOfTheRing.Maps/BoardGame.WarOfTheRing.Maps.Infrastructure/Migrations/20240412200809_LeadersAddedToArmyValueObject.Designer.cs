...
namespace BoardGame.WarOfTheRing.Maps.Infrastructure.Migrations
{
    ...
    [Migration("20240412200809_LeadersAddedToArmyValueObject")]
    partial class LeadersAddedToArmyValueObject
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("BoardGame.WarOfTheRing.Maps.Domain.Aggregates.Maps.ValueObjects.Army", "Reinforcements", b1 =>
                        {
                            ...
                            b1.OwnsMany("BoardGame.WarOfTheRing.Maps.Domain.Aggregates.Maps.ValueObjects.Leader", "Leaders", b2 =>
                                {
